...
namespace ConexionBD
{
    public class Datos
    {
        ...
        public Datos(String objNombre, Object objValor)
        {
            m_Nombre = objNombre;
            m_Valor = objValor;
        ...
        public Datos (String objNombre, Object objValor, SqlDbType objTipoDato, ParameterDirection objDireccion, int objTamaño)
        {
            m_Nombre = objNombre;
            m_Valor = objValor;
