...
namespace ConexionDB
{
    ...
    {
        public SqlConnection conexion = new SqlConnection("Server=LEIVA\\SQLEXPRESS;DataBase=Factura;Integrated Security=SSPI");
        ...
        public DataTable Listado(String NombreSP, List<Data> lst)
        {
        ...
        public void EjecutarSP(String NombreSP, ref List<Data> lst)
        {
            SqlCommand cmd;
            try
            {
