...
namespace ConexionDB
{
    public class Data
    {
        ...
        public Data(String objNombre, Object objValor)
        {
            m_Nombre = objNombre;
            m_Valor = objValor;
        ...
        public Data(String objNombre, Object objValor, SqlDbType objTipoDato, ParameterDirection objDireccion, int objTamaño)
        {
            m_Nombre = objNombre;
            m_Valor = objValor;
